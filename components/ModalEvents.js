...
export default function ModalEvents({ props, locale }) {
  return (
    <>
          ...
          >
            <div className="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
              ...
              <div className="relative flex-auto p-4" data-te-modal-body-ref>
                ...
                <p className="mt-4 capitalize font-bold italic text-lg">{event.description[locale]}</p>
                <p className="mt-2 text-center text-lg">{new Date(event.date).toLocaleDateString(locale, {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}</p>
                ...
                <MarkdownContent markdownText={event.detailed_description[locale]} />
              </div>
